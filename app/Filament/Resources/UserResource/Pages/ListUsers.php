...
class ListUsers extends ListRecords
{
    ...
    public function getTabs(): array
    {
        ...
        $tabs = [
            ...
            'alumni' => Tab::make()->query(fn($query) => $query->with('roles')->whereRelation('roles', 'name', '=', 'alumni')),
            'rektor' => Tab::make()->query(fn($query) => $query->with('roles')->whereRelation('roles', 'name', '=', 'rektor')),
        ];
